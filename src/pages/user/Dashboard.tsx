...
import { Calendar, Package, Clock, ChevronRight, Bell } from "lucide-react";
...
const Dashboard = () => {
  ...
  // User's loyalty information (this would come from an API in a real app)
  const loyaltyInfo = {
      ...
      <div className="grid gap-6">
        ...
        <Card className="border-l-4 border-l-blue-500">
          <CardContent className="p-4 flex gap-3 items-start">
            <Bell className="mt-1 h-5 w-5 text-blue-500 flex-shrink-0" />
            <div>
              <h4 className="font-medium">Limited Time Offer</h4>
              <p className="text-sm text-gray-600">
                Get 20% off on all skincare products until the end of the month. Use code SKIN20 at checkout.
              </p>
              <Button variant="ghost" size="sm" className="mt-2 text-blue-500 p-0 h-auto">
